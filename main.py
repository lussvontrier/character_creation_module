...
from graphic_arts import start_game_banner


def attack(char_name: str, char_class: str) -> str:
    """Checks the char_class and returns appropriate attack message."""
...
def defence(char_name: str, char_class: str) -> str:
    """Checks the char_class and returns appropriate defence message."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Checks the char_class and returns appropriate special move message."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Checks the char_class and prints appropriate training message."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Prompts the user to input character name and proceed to game."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    start_game_banner.run_screensaver()
